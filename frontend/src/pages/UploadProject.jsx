...
export const UploadProject = () => {
  ...
  const handleCreditsChange = (e) => setCredits(e.target.value);
   ...
   {uploadSuccessful && <PopupMessage />}
    ...
    <div className="laptop:grid laptop:grid-cols-2 laptop:gap-8">
      ...
      <div className="laptop:order-2 laptop:flex laptop:flex-col laptop:justify-end">
        ...
        {/* Credits Section */}
        <div className="border-2 border-dotted border-main-dark min-h-[150px] h-fit w-full mb-8 laptop:mb-4 text-main-dark"
                onClick={() => {
                  if (editingField !== "credits") {
                    toggleEditMode("credits");
                  }
                }}>
          {editingField === "credits" ? (
            ...
            <>
              <p className="font-body p-4 break-words">{credits || "Credits"}</p>
            </>
          )}
        </div>
        <div className="flex gap-2 justify-end mt-2 text-main-dark">
          {editingField === "credits" ? (
            ...
            <>
              <h3
                onClick={() => toggleEditMode("credits")}
      ...
      {editingField === "videoLink" ? (
            ...
            <>
              <p className="font-body p-4 overflow-hidden text-ellipsis">{videoLink || "https://example.com"}</p>
            </>
          )}
      </div>
        <div
